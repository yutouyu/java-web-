...
<Table>
    <tr>
        <td>
            <form action="orderdetail1.jsp?orderdetail=<%=orderId%>" method=post style="margin: auto">
    ...
    <tr>
        <td>
            <form action="orderdetail1.jsp?orderdetail=<%=orderId%>" method=post>
...
<input type ='button'  value='返回' onclick="window.location.href='saleinfo.jsp'">
</body>
</html>
